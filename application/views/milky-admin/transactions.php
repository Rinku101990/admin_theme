 ...
 <div class="content-header row">
          ...
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Transaction List</a>
                </li>
              </ol>
            </div>
          </div>
        ...
        <div class="content-header-right col-md-6 col-12">
          <div class="dropdown float-md-right">
            <button onclick="location.href = '<?php echo base_url("milky-admin/orders/addPayment");?>';" class="btn btn-danger round btn-glow px-2" 
            type="button"><i class="fa fa-list"></i> Add Payment</button>
          </div>
        </div>
      </div>
                        ...
                        <tr>
						 ...
						 <span class="dropdown">
                              ...
                              <span class="dropdown-menu mt-1 dropdown-menu-right">
                                ...
                                <a href="#" class="dropdown-item"><i class="fa fa-eye"></i> View Invoice</a>
                                <a href="#" class="dropdown-item"><i class="fa fa-user"></i> Buyer Details</a>
                                <a href="#" class="dropdown-item"><i class="fa fa-user"></i> Vendore Details</a>
